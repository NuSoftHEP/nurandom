...
#ifndef NURANDOM_RANDOMUTILS_PROVIDERS_STANDARDPOLICIES_H
#define NURANDOM_RANDOMUTILS_PROVIDERS_STANDARDPOLICIES_H 1
...
#endif // NURANDOM_RANDOMUTILS_PROVIDERS_STANDARDPOLICIES_H
